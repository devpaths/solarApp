...
const Register = () => {
  ...
  return (
        ...
        {isEmailSelected && (
         ...
         />
          ...
          <Text style={{color:'black' , marginLeft:15,marginTop:20,marginBottom:-8,fontSize:12}}>E-mail</Text>
            <TextInput style={[styles.input]} placeholderTextColor='#999' placeholder="Please enter email address" />
          </>
        )}
    ...
    margin: 10,marginTop:0,}} placeholder="Phone Number" placeholderTextColor='#999' />
          </>
        ...
        <TextInput style={[styles.input]} placeholder="Please enter password" placeholderTextColor='#999' secureTextEntry />
        <TouchableOpacity style={[styles.donebtn]} onPress={backtoLogin}>
          <Text>Done</Text>
        </TouchableOpacity>
      </View>
    </View>
