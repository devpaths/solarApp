      ...
      case 'email':
        return (
          <View>
            ...
            <TextInput  value={email} onChangeText={value => setEmail(value)} style={styles.input} placeholder="Email" placeholderTextColor='#999' />
            <Text style={{ color: 'black', marginBottom: 10, marginLeft: -25, fontSize: 12 }}>Password</Text>
            <TextInput value={password} onChangeText={value => setPassword(value)}  style={styles.input} placeholder="Password" secureTextEntry={true} placeholderTextColor='#999' />
          </View>
        );
      case 'phoneNumber':
        return (
    ...
    <View style={styles.mainview}>
      ...
      >
        ...
        <View style={styles.loginbtn}>
          ...
          <TouchableOpacity onPress={navigateToRegister} style={{ backgroundColor: 'white', marginTop: -250, marginLeft: 24 }}>
            <Text style={{ color: 'black', fontSize: 12 }}>Register a new Account</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={navigateToRegister} style={{ backgroundColor: 'white', marginTop: -18, marginLeft: 274 }}>
            <Text style={{ color: 'black', fontSize: 12 }}>Forgot Password?</Text>
          </TouchableOpacity>
        </View>
